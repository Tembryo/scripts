...
git clone https://github.com/Tembryo/wisdota-download.git
git clone https://github.com/Tembryo/wisdota-analysis.git
git clone https://github.com/Tembryo/wisdota-crawl.git

git clone https://github.com/Tembryo/wisdota-dataset-export.git

git clone https://github.com/Tembryo/database-queries.git